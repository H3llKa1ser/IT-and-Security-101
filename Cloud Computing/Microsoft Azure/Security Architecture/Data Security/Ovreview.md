...
1) Deploy Microsoft Purview Information Protection for your organization.

2) Apply labels that reflect your business requirements. For example: Apply a label named "highly confidential" to all documents and emails that contain top-secret data, to classify and protect this data. Then, only authorized users can access this data, with any restrictions that you specify.

3) Configure usage logging for Azure RMS so that you can monitor how your organization is using the protection service.
