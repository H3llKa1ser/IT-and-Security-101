...
1) Lock down access to your subscription, resource group, and key vaults (role-based access control (RBAC)).

2) Create access policies for every vault.

3) Use the principle of least privilege access to grant access.

4) Turn on firewall and virtual network service endpoints.
