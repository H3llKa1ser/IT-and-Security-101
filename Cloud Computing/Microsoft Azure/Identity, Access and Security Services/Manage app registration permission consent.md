...
![image](https://github.com/user-attachments/assets/849d9c4c-67aa-41e1-a4bb-2ebb2c537a9f)
...
1) When previously granted consent is revoked.

2) When the application is coded to specifically prompt for consent during sign-in.

3) When the application uses dynamic consent to ask for new permissions as needed at run time.
